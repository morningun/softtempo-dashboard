...
const NOTION_API_KEY = "YOUR_NOTION_INTEGRATION_TOKEN"; // 노션에서 발급받은 API 키
const NOTION_DATABASE_ID = "YOUR_NOTION_DATABASE_ID";  // 생성한 노션 표의 ID
  ...
  try {
    ...
    const response = await notion.pages.create({
      ...
      properties: {
        ...
        '⏱️ 템포 (BPM)': {
          select: { name: musicData.bpm || '100 BPM' }
        },
